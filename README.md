...
This Java library implements the methods and types in [Telegram's Bot API](https://core.telegram.org/bots) through version 6.3. [Telegram](https://telegram.org/) is an instant messenger for various platforms.
